...
using array_double = py::ndarray<double, py::c_contig, Args...>;
template <typename... Args>
using array_int = py::ndarray<int, py::c_contig, Args...>;
template <typename... Args>
using array_size_t = py::ndarray<size_t, py::c_contig, Args...>;
py::tuple version_tuple();
py::str version_string();
py::str version_full();
py::str commit();
std::optional<py::dict> dataset(array_double<> lattice,
...
std::optional<py::dict> spacegroup_type_from_symmetry(
...
std::optional<py::int_> symmetry(array_int<> rotations,
                                 array_double<> translations,
...
std::optional<py::int_> symmetry_with_site_tensors(
    ...
    py::float_ symprec, py::float_ angle_tolerance, py::float_ mag_symprec);
std::optional<py::int_> primitive(array_double<> lattice,
                                  array_double<> positions,
                                  array_int<> atom_types, py::float_ symprec,
                                  py::float_ angle_tolerance);
